...
public class ArticleDetailActivity extends ActionBarActivity
    ...
    private final SharedElementCallback sharedElementCallback = new SharedElementCallback() {
        ...
        public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            ...
            if (mIsReturning) {
                View sharedElement = mCurrentArticleDetailFragment.getArticleImage();
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            mCursor.moveToPosition(position);
            return ArticleDetailFragment.newInstance(mCursor.getLong(ArticleLoader.Query._ID), position, mStartingPosition, imageUrl);
        }
